            ...
            else
            {
                ...
                switch (reason)
                {
                    ...
                    case 2: //max npcbots exceed
                        ch.PSendSysMessage(LocalizedNpcText(player, BOT_TEXT_HIREFAIL_MAXBOTS).c_str(), player->GetMaxNpcBotsCount());
                        BotSay("...", player);
                        break;
...
{ "Prayer of Mending", "愈合" },
{ "Divine Hymn", "神圣赞美诗" },
{ "Power Word: Fortitude", "真言术：韧" },
{ "Divine Spirit", "神圣之灵" },
{ "Shadow Protection", "暗影防护结界" },
